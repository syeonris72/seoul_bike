...
from models.models import StationLoc, KoreaHolidays, RentHistory2024, DemandPredictMaster
...
if __name__ == "__main__":
    init_db(engine, models=[StationLoc, KoreaHolidays, RentHistory2024, DemandPredictMaster])  # DB 초기화
