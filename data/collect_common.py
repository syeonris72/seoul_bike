...
from models.models import StationLoc, KoreaHolidays, RentHistory, DemandPredictMaster
...
if __name__ == "__main__":
    init_db(engine, models=[StationLoc, KoreaHolidays, RentHistory, DemandPredictMaster])  # DB 초기화
